...
class AdConrtoller extends Controller
{
    public function index()
    {
        ...
        return ApiResponse::sendResponse(200, 'No Ads aviliable', []);
    }
    ...
    public function latest()
    {
        ...
        if ($ads) {
            return ApiResponse::sendResponse(200, 'Latest Ads Successfuly', AdResource::collection($ads));
        }
        return ApiResponse::sendResponse(200, 'No latest Ads', []);
    }
    ...
    public function domain($domain_id)
    {
        ...
        if ($ads) {
            return ApiResponse::sendResponse(200, 'domain Ads Successfuly', AdResource::collection($ads));
        }
        return ApiResponse::sendResponse(200, 'No domain in  Ads', []);
    }
